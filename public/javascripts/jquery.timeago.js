...
(function($) {
  ...
  // Convert dates to a wire (string) format using a subset of the ISO-8601 standard
  Date.prototype.toISOString = function(options){
  	...
  	if(options.selector != "time"){
  		...
  		date = ["0000".substr((year+"").length)+year, _(this["getUTCMonth"]()+1), _(this["getUTCDate"]())].join('-');
  	}
  	formattedDate.push(date);

  	if(options.selector != "date"){
  		var time = [_(this["getUTCHours"]()), _(this["getUTCMinutes"]()), _(this["getUTCSeconds"]())].join(':');
